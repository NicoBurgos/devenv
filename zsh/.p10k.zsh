# Generated by Powerlevel10k configuration wizard on 2024-12-08 at 00:29 -03.
...
# Habilitar la versión de Python
  typeset -g POWERLEVEL9K_PYTHON_VERSION=on

# Personaliza el formato de la versión de Python si lo deseas
  typeset -g POWERLEVEL9K_PYTHON_VERSION_FORMAT='v$(version)'
